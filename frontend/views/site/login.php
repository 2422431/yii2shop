	...
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到京西！[<a href="login.php">登录</a>] [<a href="regist.php">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
			...
			<div class="login_form fl">
				<form action="" method="post" id="reg_form">
					...
					<ul>
						...
						<li>
							<label for="">&nbsp;</label>
							<input type="checkbox" class="chb"  name="LoginForm[rememberMe]"/> 保存登录信息
						</li>
						<li>
							<label for="">&nbsp;</label>
<!--							<input type="button" value="" class="login_btn" />-->
    ...
    //3.得到表单中所有数据
        ...
        $.post("/site/login", $("#reg_form").serialize(), function (data) {
            console.dir(data);
//            if (data.status) {
//                alert(data.msg);
//            } else {
