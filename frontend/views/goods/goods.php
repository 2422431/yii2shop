...
<head>
	...
	<link rel="stylesheet" href="/static/style/goods.css" type="text/css">
	...
	<!--引入jqzoom css -->
	<link rel="stylesheet" href="/static/style/jqzoom.css" type="text/css">

	<script type="text/javascript" src="/static/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="/static/js/header.js"></script>
	<script type="text/javascript" src="/static/js/goods.js"></script>
	<script type="text/javascript" src="/static/js/jqzoom-core.js"></script>
...
<body>
	...
	<div class="main w1210 mt10 bc">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/static/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/static/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/static/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/static/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/static/images/relate_view5.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?= $cate->name?></strong></h3>
				
				<!-- 图片预览区域 start -->
                <div class="preview fl">
                    <div class="midpic">
                        <a href="<?=$cate->images[0]->path."?imageView2/1/w/800/h/800"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                            <img src="<?=$cate->images[0]->path."?imageView2/1/w/350/h/350"?>" alt="" />               <!-- 第一幅图片的中图 -->
                        </a>
                    </div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php foreach ($cate->images as $k=>$v):?>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?=$cate->sn;?></li>
						<li class="market_price"><span>定价：</span><em><?=$cate->market_price;?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong><?=$cate->shop_price;?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?=$cate->createtime;?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="<?=\yii\helpers\Url::to(['add-cart'])?>" method="get" class="choose">
				...
				<div class="detail_bd">
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/static/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/static/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/static/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
