...
<head>
	...
	<link rel="stylesheet" href="/static/style/cart.css" type="text/css">
...
<body>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
            ...
            <?php foreach ($goods as $good):?>
                <tr id="<?=$good['id']?>">
					...
					<td class="col5">￥<span><?=$good['num']*$good['shop_price']?>.00</span></td>
					<td class="col6"><a href="javascript:void(0) " id="del">删除</a></td>
				</tr>
            <?php endforeach;?>
			</tbody>
			<tfoot>
		...
		<div class="cart_btn w990 bc mt10">
			<a href="/goods/lists?id=1" class="continue">继续购物</a>
